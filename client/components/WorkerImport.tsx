...
export const WorkerImport: React.FC<WorkerImportProps> = ({
  ...
  const columnMappings = {
    ...
    'eponge': ['eponge', 'éponge', 'sponge', 'eponge oui non', 'eponge (oui/non)'],
  ...
  const validateWorkerData = (data: any, rowIndex: number): ImportedWorker => {
    ...
    console.log(`🛏️ Row ${rowIndex} lit value:`, data.lit);
    ...
    // Validate EPONGE and LIT allocation
    const allocatedItems: Omit<AllocatedItem, 'id'>[] = [];

    // Process EPONGE and preserve raw value
    ...
    // Add allocated items to worker
    if (allocatedItems.length > 0) {
      worker.allocatedItems = allocatedItems;
    }
      ...
      <div className="space-y-4">
        ...
        <Alert>
          ...
          <AlertDescription>
            ...
            <strong>⚠️ Stock:</strong> Si le stock EPONGE ou LIT est insuffisant, une erreur sera affichée
            <br />
            <Button
              variant="link"
    ...
    <div className="space-y-6">
      ...
      {importedWorkers.length > 0 && (
        <Alert className="bg-blue-50 border-blue-200">
          ...
          <AlertDescription>
            <strong className="text-blue-800">Colonnes d��tectées dans votre fichier:</strong>
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="w-[98vw] max-w-6xl mx-1 sm:mx-auto max-h-[90vh] overflow-hidden flex flex-col mobile-dialog-container">
        <DialogHeader className="mobile-dialog-header">
          ...
          <DialogDescription>
            {step === 'upload' && 'Tél��chargez un fichier Excel contenant les données des ouvriers'}
